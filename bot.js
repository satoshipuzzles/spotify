...
console.log(`🚀 Subscribing for notes that tag ${BOT_PK} on ${RELAYS.join(', ')}`);

// --- Subscribe with a single filter object ---
pool.subscribe(
  RELAYS,
  { kinds: [1], '#p': [BOT_PK] },
  {
