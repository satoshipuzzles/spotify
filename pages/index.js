                ...
                <div key={pubkey} className="bg-gray-800 rounded-lg overflow-hidden shadow-lg border border-gray-700">
                  <div className="p-4 border-b border-gray-700 flex items-center justify-between">
                    <div className="flex items-center">
                      ...
                      {profilePic ? (
                        <img src={profilePic} alt="" className="w-10 h-10 rounded-full border border-gray-600" />
                      ) : (
                        <div className="w-10 h-10 bg-gradient-to-br from-purple-600 to-purple-800 rounded-full flex items-center justify-center text-sm text-white font-bold">
                          {pubkey.substring(0, 2).toUpperCase()}
                        </div>
                      )}
                      <div className="ml-3">
                        <h3 className="font-medium text-gray-200">{name || `User ${pubkey.substring(0, 6)}...`}</h3>
                  ...
                  <div className="w-full bg-black">
                    <iframe 
                      ...
                      loading="lazy"
                      title={`Playlist by ${name || pubkey.substring(0, 8)}`}
                    ></iframe>
                  </div>
                </div>
              ))}
